...
public class MachineRecipeLoader {
    ...
    private static void registerBlastFurnaceRecipes() {
        ...
        RecipeMaps.BLAST_RECIPES.recipeBuilder().duration((int) Math.max(Materials.BoronCarbide.getAverageMass() / 40, 1) * Materials.BoronCarbide.blastFurnaceTemperature).EUt(480).input(OrePrefix.dust, Materials.Boron, 1).input(OrePrefix.dust, Materials.Carbon, 1).outputs(OreDictUnifier.get(OrePrefix.ingotHot, Materials.BoronCarbide, 1), OreDictUnifier.get(OrePrefix.dustSmall, Materials.Ash, 2)).blastFurnaceTemp(Materials.BoronCarbide.blastFurnaceTemperature).buildAndRegister();
